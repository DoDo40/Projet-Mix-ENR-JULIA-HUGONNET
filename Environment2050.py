...
class MixEnv(py_environment.PyEnvironment):
    ...
    def _reset(self):
        ...
        self._state = np.concatenate((
            [np.random.uniform(0.8, 1.), np.random.uniform(0.8, 1.), np.random.uniform(0.8, 1.) * 0.5 + biogas,
    ...
    def _perform_action(self, action):
        ...
        if prodRes <= 0:
            ...
            reward -= 1 + self.produit / prodRes * 1  # Récompense en fct de la
