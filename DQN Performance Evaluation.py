...
# Charger la politique de l'agent
policy_dir = 'DQN_policy_directory'  # Mettez à jour avec votre répertoire de politique
...
print("Avec la police de l'agent, les GWh non fournies sur l'année 2022 avec les données de " + scenario + " sont de " +
